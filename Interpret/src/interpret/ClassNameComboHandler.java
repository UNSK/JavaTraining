...
/**
 * suggest class name for text field
 */
public class ClassNameComboHandler extends KeyAdapter {
    private final JComboBox<String> comboBox;
    private final Vector<String> list = new Vector<>();

    public ClassNameComboHandler(JComboBox<String> combo) {
        this.comboBox = combo;
    ...
    public void keyTyped(final KeyEvent e) {
        EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                ...
                if (text.length() == 0) {
                    setSuggestionModel(comboBox, new DefaultComboBoxModel<>(
                            list), "");
                    comboBox.hidePopup();
                } else {
    ...
    private static ComboBoxModel<String> getSuggestedModel(Vector<String> list,
            String text) {
